...
import com.objdetector.deepmodel.ProcessedResult;
import com.objdetector.deepmodel.ObjectDetectionHelper;
...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private ObjectDetectionHelper objectDetector;
    ...
    public void onPreviewSizeChosen(final Size previewSize, final int rotation) {
        ...
        try {
            objectDetector = ObjectDetectionHelper.create(getAssets());
    ...
    public void onImageAvailable(final ImageReader reader) {
        ...
        runInBackground(() -> {
            final List<ProcessedResult> results = objectDetector.detectObjects(imageBitmapForModel);
